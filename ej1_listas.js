    ...
    for(var x=0; x<=19; x++){
        if(x%2>0){
            lista_impares.push(x);
        }
    }
     console.log("NumerosListados"+ lista_impares);
    // Crea una lista de comida.
    var lista_comida=["Spagetti","Sopa","Cacata","Bebés","Durum","Hamburguesa","Almejas"];
